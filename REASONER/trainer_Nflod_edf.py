...
from model_edf.loss import CrossEntropy_Loss, MSELoss, Feature_Level_Consistency_Loss, MultVariateKLD
import model.metric as module_metric
# import model.model_CNN_VIT1 as module_arch  # model_EEG_CNNvit_Orthogv2
import model_edf.model as module_arch  # model_EEG_CNNvit_Orthogv2
from parse_config import ConfigParser
from trainer.trainer_miss_edf import Trainer
...
if __name__ == '__main__':
    ...
    args.add_argument('-f', '--fold_id', type=str, default="1",
                      help='fold_id')
    args.add_argument('-da', '--np_data_dir', type=str, default="data/output_data/physionet_20_EEG_EOG_00/",
    ...
    args.add_argument('-d', '--device', default="0", type=str,
                      help='indices of GPUs to enable (default: all)')
    args.add_argument('-f', '--fold_id', type=str, default="15",
                      help='fold_id')
    args.add_argument('-da', '--np_data_dir', type=str, default="data/output_data/physionet_20_EEG_EOG_00/",
                      help='Directory containing numpy files')
    ...
    args.add_argument('-d', '--device', default="0", type=str,
                      help='indices of GPUs to enable (default: all)')
    args.add_argument('-f', '--fold_id', type=str, default="16",
                      help='fold_id')
    args.add_argument('-da', '--np_data_dir', type=str, default="data/output_data/physionet_20_EEG_EOG_00/",
                      help='Directory containing numpy files')
    ...
    args.add_argument('-d', '--device', default="0", type=str,
                      help='indices of GPUs to enable (default: all)')
    args.add_argument('-f', '--fold_id', type=str, default="17",
                      help='fold_id')
    args.add_argument('-da', '--np_data_dir', type=str, default="data/output_data/physionet_20_EEG_EOG_00/",
                      help='Directory containing numpy files')
    ...
    args.add_argument('-d', '--device', default="0", type=str,
                      help='indices of GPUs to enable (default: all)')
    args.add_argument('-f', '--fold_id', type=str, default="18",
                      help='fold_id')
    args.add_argument('-da', '--np_data_dir', type=str, default="data/output_data/physionet_20_EEG_EOG_00/",
                      help='Directory containing numpy files')
    ...
    args.add_argument('-d', '--device', default="0", type=str,
                      help='indices of GPUs to enable (default: all)')
    args.add_argument('-f', '--fold_id', type=str, default="19",
                      help='fold_id')
    args.add_argument('-da', '--np_data_dir', type=str, default="data/output_data/physionet_20_EEG_EOG_00/",
                      help='Directory containing numpy files')
