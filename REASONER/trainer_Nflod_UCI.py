...
from model_UCI.loss import CrossEntropy_Loss, MSELoss, Feature_Level_Consistency_Loss, MultVariateKLD
import model.metric as module_metric
# import model.model_CNN_VIT1 as module_arch  # model_EEG_CNNvit_Orthogv2
import model_UCI.model as module_arch  # model_EEG_CNNvit_Orthogv2
from parse_config import ConfigParser
from trainer.trainer_miss_UCI import Trainer
...
def main(config, fold_id):
    ...
    criterion_MSE_m3 = MSELoss()
    criterion_Feature_Level1 = Feature_Level_Consistency_Loss()
    criterion_Context_Level1 = MultVariateKLD(reduction='mean')
    criterion_Feature_Level2 = Feature_Level_Consistency_Loss()
    criterion_Context_Level2 = MultVariateKLD(reduction='mean')
    criterion_Feature_Level3 = Feature_Level_Consistency_Loss()
    criterion_Context_Level3 = MultVariateKLD(reduction='mean')
    ...
    trainer = Trainer(model, criterion, criterion_MSE_m1, criterion_MSE_m2,criterion_MSE_m3, criterion_Feature_Level1,
                      criterion_Context_Level1,criterion_Feature_Level2,
                      criterion_Context_Level2,criterion_Feature_Level3,
                      criterion_Context_Level3, criterion_MSE_P1, criterion_MSE_P2, metrics,
                      optimizer,
                      config=config,
...
if __name__ == '__main__':
    ...
    args.add_argument('-f', '--fold_id', type=str, default="0",
                      help='fold_id')
    args.add_argument('-da', '--np_data_dir', type=str, default="data/output_data/UCI_00/",
