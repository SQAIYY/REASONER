...
class BaseTrainer:
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            result, epoch_outs, epoch_trgs, epoch_probs = self._train_epoch(epoch, self.epochs)
            #print("1",result)
            #print("2",epoch_outs)
            #print("3",epoch_trgs)
    ...
    def _calc_metrics(self):
        ...
        #print(self.config["data_loader"]["args"]["num_folds"])
        #print(len(outs_list))
        #print(self.config["data_loader"]["args"]["num_folds"])
